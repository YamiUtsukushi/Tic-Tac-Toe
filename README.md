...
|-------------------------------------------------|-------------------------------------------------|-------------------------------------------------|------------------------------------------|
| <img src="tic_tac_toe_start_screenshot.png" alt="Écran de démarrage" width="250"/> | <img src="tic_tac_toe_screenshot_in_game.png" alt="Aperçu du jeu Tic Tac Toe" width="250"/> | <img src="tic_tac_toe_win_screenshot.png" alt="Aperçu du jeu Tic Tac Toe après victoire" width="250"/> | <img src="tic_tac_toe_draw_screenshot.png" alt="Aperçu du jeu Tic Tac Toe après un match nul" width="250"/> |
